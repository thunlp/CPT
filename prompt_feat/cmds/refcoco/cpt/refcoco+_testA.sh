rm output/refcoco/cpt/inference/refcoco+_testA/*

CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
	--master_port 10093 --nproc_per_node=4 tools/test_refcoco_net.py \
	...
	DATA_DIR "data/refcoco/yamls/refcoco+_testA.yaml" \
