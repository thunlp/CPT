...
CUDA_VISIBLE_DEVICES=$GPU_N python -m torch.distributed.launch \
	--master_port 1009$GPU_N --nproc_per_node=1 oscar/fewshot/vcr_ft.py -j 4 --img_feature_dim 2054 --max_img_seq_length 45 \
	...
	--task_name $TASK_NAME --do_lower_case --max_seq_length 165 --per_gpu_eval_batch_size 16 \
	--per_gpu_train_batch_size 4 --learning_rate 6e-05 --num_train_epochs $EPOCHS  --output_dir output/vcr/fsl_color \
