...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch \
	--master_port 10093 --nproc_per_node=4 oscar/fewshot/gqa_cpt.py -j 4 --img_feature_dim 2054 --max_img_seq_length 45 \
	...
	--per_gpu_train_batch_size 4 --learning_rate 6e-05 --num_train_epochs $EPOCH --output_dir output/gqa/fsl \
