...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch \
	...
	--train_dir /data_local/zhangao/codes/prompt_feat/output/normal_finetune/inference/refcoco_train/ \
	--test_dir /data_local/zhangao/codes/prompt_feat/output/normal_finetune/inference/refcoco_testB/ \
	--do_lower_case \
	--add_od_labels \
	--learning_rate 0.02 \
