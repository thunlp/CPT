...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch \
	...
	--model_name_or_path  output/normal_finetune/refcocog/best \
	--eval_model_dir output/normal_finetune/refcocog/best \
	...
	--test_dir /data_local/zhangao/codes/prompt_feat/output/normal_finetune/inference/refcocog_test/ \
	--do_lower_case \
	--add_od_labels \
	--learning_rate 0.02 \
