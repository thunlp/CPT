...
from oscar.modeling.modeling_bert import BertForImageCaptioning, BertPreTrainedModel
...
def main():
    ...
    config_class, model_class, tokenizer_class = BertConfig, BertPreTrainedModel, BertTokenizer
    if args.do_train:
